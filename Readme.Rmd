...
## Viral Marketing Section 

### Cats

```{r, cache=TRUE}
cats <- wp_trend("Cat", from="2010-01-01")
...
```{r, cache=TRUE}
ebola <- wp_trend("Ebola", from="2008-01-01")
plot( cats, 
      col=ifelse( wp_wday(ebolas$date) > 5 , "red", "black") ,
      ylim=c(0, max(ebola$count)),
